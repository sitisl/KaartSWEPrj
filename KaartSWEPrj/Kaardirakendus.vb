...
'        Return
'    End If
'    Dim longCoord As Double = CDbl(Val(txtLong.Text))
'    Dim latCoord As Double = CDbl(Val(txtLat.Text))
'    GMapControl1.ShowCenter = False
'    GMapControl1.Position = New GMap.NET.PointLatLng(longCoord, latCoord)
'    GMapControl1.Position = New GMap.NET.PointLatLng(59.4231962726054, 24.694921814958523)


'    GMapControl1.SetPositionByKeywords("Tallinn")
...
'UCtrlMapViewer1: GMapControl1.ShowCenter = False

'    GMapControl1.SetPositionByKeywords(txtAsukoht.Text)
'    GMapControl1.SetPositionByKeywords("Chennai,India")
